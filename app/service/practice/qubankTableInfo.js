...
class VerifCodeService extends Service {
  ...
  async generateVerificationCode(applicantId, issuerId, expiryTime) {
    ...
    // 存储到数据库
    const verifCode = await this.ctx.model.CommonVerifCode.create({
...
module.exports = VerifCodeService;
